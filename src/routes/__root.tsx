...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "현대 무용 아카이브" },
      { name: "description", content: "세계의 위대한 현대 무용 작품들을 만나세요" },
      { name: "author", content: "현대 무용 아카이브" },
      { property: "og:title", content: "현대 무용 아카이브" },
      { property: "og:description", content: "세계의 위대한 현대 무용 작품들을 만나세요" },
